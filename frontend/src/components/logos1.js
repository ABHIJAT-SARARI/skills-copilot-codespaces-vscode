...
Logos1.defaultProps = {
  logo1Alt: 'AI and Data Science Enthusiasts Logo',
  logo3Src:
  ...
  logo5Alt: 'Professionals Logo',
  logo2Alt: 'Curated Content Logo',
  logo3Alt: 'Insights and Breakthroughs Logo',
  logo2Src:
