...
const Infographicsdetails = (props) => {
  return (
    <div className="infographicsdetails-container10">
      <Helmet>
        <title>Infographicsdetails - Character NFT template</title>
        <meta
          property="og:title"
          content="Infographicsdetails - Character NFT template"
        />
      </Helmet>
      <header className="infographicsdetails-header1">
        <header data-thq="thq-navbar" className="infographicsdetails-navbar">
          <span className="infographicsdetails-logo1">Character</span>
          <div
            data-thq="thq-navbar-nav"
            data-role="Nav"
            className="infographicsdetails-desktop-menu"
          >
            <nav
              data-thq="thq-navbar-nav-links"
              data-role="Nav"
              className="infographicsdetails-nav1"
            ></nav>
          </div>
          <div
            data-thq="thq-navbar-btn-group"
            className="infographicsdetails-btn-group"
          >
            <div className="infographicsdetails-socials"></div>
          </div>
          <div
            data-thq="thq-burger-menu"
            className="infographicsdetails-burger-menu"
          >
            <button className="button infographicsdetails-button">
              <svg
                viewBox="0 0 1024 1024"
                className="infographicsdetails-icon10"
              >
          ...
          <div
            ...
            className="infographicsdetails-mobile-menu"
          >
            <div
            ...
            >
              <div className="infographicsdetails-container11">
                ...
                >
                  <svg
                    viewBox="0 0 1024 1024"
                    className="infographicsdetails-icon12"
                  >
            ...
            <div className="infographicsdetails-icon-group">
              <svg
                ...
                className="infographicsdetails-icon14"
              >
              ...
              <svg
                ...
                className="infographicsdetails-icon16"
              >
              ...
              <svg
                ...
                className="infographicsdetails-icon18"
              >
          ...
          <Link
            to="/articles"
            className="infographicsdetails-navlink1 button-clean button"
          >
            Home
          </Link>
          <Link
            to="/articles"
            className="infographicsdetails-navlink2 button-clean button"
          >
            Articles
          </Link>
          <Link
            to="/articles"
            className="infographicsdetails-navlink3 button-clean button"
          >
            About
          </Link>
        </header>
      ...
      <section className="infographicsdetails-hero">
        <div className="infographicsdetails-heading">
          <h1 className="infographicsdetails-header2">
            The AI Evolution: Key Milestones Through the Decades
          </h1>
          <p className="infographicsdetails-caption">
        ...
        <div className="infographicsdetails-container13">
          ...
          <div className="infographicsdetails-container16">
            <div className="infographicsdetails-container17">
              <span className="infographicsdetails-text17">
                Organization , university, aper talk
              </span>
            </div>
            <span className="infographicsdetails-text18">
              Taigs and category
            </span>
          </div>
        </div>
