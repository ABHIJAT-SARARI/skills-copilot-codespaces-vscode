    ...
    <div className="articles-container1">
      ...
      <header className="home-header1">
        <header data-thq="thq-navbar" className="home-navbar">
          ...
          <div
            ...
            data-role="Nav"
            className="articles-desktop-menu"
          >
            <nav
          ...
          <div data-thq="thq-burger-menu" className="articles-burger-menu">
            <button className="button articles-button">
              <svg viewBox="0 0 1024 1024" className="articles-icon10">
      ...
      <section className="articles-hero">
        <div className="articles-heading">
          <h1 className="articles-header2">Articles &amp; Insights</h1>
          <p className="articles-caption">
            Explore our curated articles on artificial intelligence, data
            science, and machine learning—crafted for learners, professionals,
            and enthusiasts.
          </p>
        </div>
